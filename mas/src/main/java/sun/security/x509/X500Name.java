...
public class X500Name implements GeneralNameInterface, Principal {
     ...
     * @param commonName common name of a person, e.g. "Vivette Davis"
     * @param organizationUnit small organization name, e.g. "Purchasing"
     * @param domainComponent dc=
     * @param organization large organization name, e.g. "Onizuka, Inc."
     * @param containsDC to differentiate from other constructor
     */
    public X500Name(String commonName, String organizationUnit,
    ...
    throws IOException {
        ...
        names[2].assertion[0] = new AVA(orgUnitName_oid,
                new DerValue(organizationUnit));
        names[1] = new RDN(1);
        names[1].assertion[0] = new AVA(DOMAIN_COMPONENT_OID,
                new DerValue(domainComponent));
        names[0] = new RDN(1);
        names[0].assertion[0] = new AVA(orgName_oid,
                new DerValue(organization));
    }

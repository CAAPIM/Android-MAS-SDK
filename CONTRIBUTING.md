...
For consistency, we ask that you adhere to some basic code guidelines when contributing to the Android Mobile SDK. See the [Code Standard and Guideline][guidelines] for details.
...
## License
By contributing to the Android Mobile SDK, you agree that your contributions will be licensed under its [license][license-link].
